    ...
    <div class="container mx-auto px-6 py-12 grid grid-cols-1 md:grid-cols-4 gap-12">
        <div class="md:col-span-2 space-y-6">
            <div class="flex items-center space-x-3">
                ...
                <h2 class="text-3xl font-bold text-white font-sans uppercase">
                    {{ config('app.name') }}</h2>
            </div>
            <p class="text-gray-300 max-w-md">
                {{ config('app.name') }} adalah sistem notifikasi otomatis yang memastikan informasi terkirim tepat
                waktu kepada pemohon maupun pegawai.
            </p>
