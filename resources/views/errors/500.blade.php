        ...
        <div class="hero-content text-center">
            <div class="max-w-xl font-semibold">
                ...
                <p class="text-lg text-base-content/80 mb-6 leading-relaxed">
                    Sepertinya server kami lagi ada kendala nih, jadi halaman ini belum bisa dibuka untuk sementara waktu.
                    <br />
                    Tim lagi cek biar semuanya cepat normal lagi.
                    <br class="my-2" />
                    Kalau butuh bantuan cepat, boleh langsung hubungi admin lewat
                    <a href="https://wa.me/6285175112406" target="_blank"
                        class="text-primary underline decoration-wavy font-semibold">WhatsApp di sini</a>.
                </p>
                ...
                <div class="mt-6 alert alert-info shadow-lg">
                    ...
                    <span class="text-sm font-semibold">
                        Tenang aja, sistemnya bakal segera balik normal kok ✨
                    </span>
                </div>
            </div>
        </div>
