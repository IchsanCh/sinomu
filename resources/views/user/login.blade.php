...
@section('title', 'Login')
@section('meta_description', 'Masuk ke akun SINOMU untuk mengelola notifikasi otomatis ke pemohon dan pegawai.')
@section('og_description', 'Login ke SINOMU dan mulai kirim notifikasi WhatsApp otomatis ke pemohon dan pegawai.')
            ...
            <div class="card bg-base-100 shadow-2xl border border-base-300">
                <div class="card-body p-8 overflow-hidden">
                    <div class="text-center mb-6" data-aos="fade-up" data-aos-duration="700">
                        ...
                        <p class="text-base-content/70">Login to your SINOMU account</p>
                    </div>
                    <form method="POST" action="{{ route('login.user') }}" id="loginForm" class="space-y-6">
                        ...
                        <button type="submit" id="loginButton" class="btn btn-primary w-full h-12 text-base font-medium"
                            title="Login" data-aos="fade-in" data-aos-duration="1100">
                    ...
                    <div class="pt-2 flex flex-row justify-between font-semibold">
                        <a href="{{ route('password.request') }}" class="underline text-primary"
                            title="Forgot Password">Forgot Password?</a>
                        <a href="{{ route('signup') }}" class="underline text-primary" title="Sign Up">Sign Up</a>
                    </div>
                </div>
            </div>
        </div>
