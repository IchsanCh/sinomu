...
@section('title', 'Permohonan Survey IKM')
        ...
        <div class="px-6 py-3">
            <div class="alert alert-info text-sm mb-3">
                ...
                <span class="font-semibold">
                    Konfigurasi pesan untuk tahapan SURVEY IKM.
                </span>
            </div>
            <div class="grid lg:grid-cols-2 gap-8">
                <div class="card bg-base-100 shadow-2xl border border-base-300">
                    <div class="card-body p-8">
                        ...
                        <form method="POST" action="{{ route('custom.pesan.ikm') }}" class="space-y-6" id="messageForm">
                            @csrf
