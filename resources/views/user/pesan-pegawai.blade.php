...
@section('title', 'Pesan Custom Penyerahan')
@section('meta_description',
    'Atur dan sesuaikan pesan notifikasi untuk pegawai. Gunakan variabel dinamis agar isi pesan
    lebih personal dan relevan.')
@section('og_description',
    'Kelola pesan custom untuk pegawai. Tambahkan variabel dinamis, pratinjau hasilnya,
            ...
            <div class="px-6 py-8">
                <div class="flex items-center gap-3">
                    <div class="w-10 h-10 rounded-lg wadbo3 flex items-center justify-center">
                        <svg class="w-5 h-5 wad4 text-primary" xmlns="http://www.w3.org/2000/svg" fill="none"
                    ...
                    <div>
                        <h1 class="text-3xl font-bold wad4">Pesan Custom Pegawai</h1>
                        <p class="text-white">Konfigurasi pesan untuk pegawai</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="grid lg:grid-cols-2 gap-8">
                        ...
                        <div class="wadb4 borderprimary rounded-2xl p-4 mb-6">
                            ...
                            <div class="flex flex-wrap gap-2">
                                <span
                                    ...
                                    onclick="insertVariable('{nama_pemohon}')">{nama_pemohon}</span>
                                <span
                                    class="badge wadb2 text-white badge-lg cursor-pointer hover:scale-105 transition-transform"
                                ...
                                <span
                                    class="badge wadb2 text-white badge-lg cursor-pointer hover:scale-105 transition-transform"
                                    onclick="insertVariable('{created_at_wib}')">{created_at_wib}</span>
                                <span
                                    class="badge wadb2 text-white badge-lg cursor-pointer hover:scale-105 transition-transform"
                                    onclick="insertVariable('{nama_pegawai}')">{nama_pegawai}</span>
                            </div>
                            <p class="text-md mt-2 font-semibold">Klik variabel untuk menambahkan ke pesan</p>
                        </div>

                        <form method="POST" action="{{ route('custom.pesan.pegawai') }}" class="space-y-6"
                            id="messageForm">
                            @csrf
                            <div class="form-control">
                                <label class="flex flex-wrap items-center gap-2">
                                    <span class="font-semibold text-base">Isi Pesan Template</span>
                                    <span class="text-base font-bold">Gunakan \n untuk baris baru</span>
                                </label>
                                <textarea name="isi_pesan" id="isi_pesan" rows="9" maxlength="500"
                            ...
                            <div class="flex flex-col flex-wrap sm:flex-row justify-end gap-3 pt-4">
                                ...
                                <button type="submit" id="submitBtn" class="btn btnprimarys">
                                    <svg class="w-5 h-5" xmlns="http://www.w3.org/2000/svg" fill="none"
                                        viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round"
                ...
                <div class="card bg-base-100 shadow-2xl border border-base-300">
                    <div class="card-body p-8">
                        <div class="flex items-center gap-3 mb-6">
                            <div class="w-10 h-10 rounded-xl wadb3 flex items-center justify-center">
                                <svg class="w-5 h-5 text-success wad4" xmlns="http://www.w3.org/2000/svg" fill="none"
                                    viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round"
                        ...
                        <div class="mt-4 p-4 wadb4 borderprimary rounded-xl">
                            ...
                            <div class="text-md space-y-1">
                                <div>Nama Pemohon: <strong>SINOMU</strong></div>
                                <div>Nomor Permohonan: <strong>20250807</strong></div>
                                <div>Tanggal Permohonan: <strong> 2025-09-11 20:31:33</strong></div>
                                ...
                                <div>Nama Pegawai: <strong>Pegawai dummy</strong></div>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", () => {
            ...
            function updatePreview() {
                ...
                text = text.replace(/{nama_pemohon}/g, "SINOMU");
                text = text.replace(/{nama_pegawai}/g, "Pegawai Dummy");
                text = text.replace(/{no_permohonan}/g, "20250807");
                text = text.replace(/{created_at_wib}/g, "2025-07-23 20:31:33");
