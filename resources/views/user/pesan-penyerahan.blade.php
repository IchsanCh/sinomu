...
@section('title', 'Pesan Custom SK Diterbitkan')
@section('meta_description',
    'Atur dan sesuaikan pesan notifikasi untuk SK diterbitkan. Gunakan variabel dinamis agar isi pesan
    lebih personal dan relevan.')
@section('og_description',
    'Kelola pesan custom untuk SK diterbitkan. Tambahkan variabel dinamis, pratinjau hasilnya,
    dan simpan template sesuai kebutuhan.')

@section('content')
    <div class="min-h-screen bg-base-100">
        <div class="wadb1 borderbc1a">
            <div class="px-6 py-8">
        ...
        <div class="px-6 py-3">
            <div class="alert alert-info text-sm mb-3">
                ...
                <span class="font-semibold">
                    Konfigurasi pesan untuk tahapan SK DITERBITKAN.
                </span>
            </div>
            <div class="grid lg:grid-cols-2 gap-8">
                <div class="card bg-base-100 shadow-2xl border border-base-300">
                    <div class="card-body p-8">
                        ...
                        <form method="POST" action="{{ route('custom.pesan.penyerahan') }}" class="space-y-6"
                            id="messageForm">
                            @csrf
