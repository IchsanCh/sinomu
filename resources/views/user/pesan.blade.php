...
@section('meta_description',
    'Pantau semua pesan otomatis yang dikirim ke pemohon. Dashboard SINOMU memudahkan Anda
...
@section('og_description',
    ...
    permohonan dengan mudah lewat Dashboard SINOMU.')

@section('content')
    <div class="min-h-screen bg-base-200">
        <div class="bg-base-100 wadb1 borderbc1">
            <div class="px-6 py-8">
                <div class="flex items-center gap-3">
                    <div class="w-10 h-10 rounded-lg wadbo3 flex items-center justify-center">
                        <svg class="h-5 w-5 wad4" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                    ...
                    <div>
                        <h1 class="text-3xl font-bold wad4">Pesan Pemohon</h1>
                        <p class="text-white">Kelola dan lihat pesan pemohon</p>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
                            <div class="form-control">
                                <label class="text-black">
                                    <span class="label-text font-medium">No Register</span>
                                </label>
                                <label class="input borderprimary flex items-center gap-2">
                                    ...
                                    <input type="text" name="search" value="{{ request('search') }}"
                                        placeholder="Ex: 20250741" class="grow" />
                                </label>
                            </div>
                            <div class="form-control">
                                <label class="text-black">
                            ...
                            <div class="form-control flex flex-col">
                                ...
                                <select name="status" class="select borderprimary">
                            ...
                            <div class="form-control">
                                ...
                                <div class="join w-full flex flex-row gap-1">
                                    <button type="submit" class="btn btnprimarys join-item flex-1">
                ...
                <table class="table table-zebra w-full">
                    <thead>
                        <tr class="bg-base-200">
                            <th class="text-left font-semibold text-xs sm:text-sm">No Register</th>
