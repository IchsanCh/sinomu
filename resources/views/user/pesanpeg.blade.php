        ...
        <div class="wadb1 borderbc1">
            <div class="px-6 py-8">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <h1 class="text-3xl font-bold wad4">Pesan Pegawai</h1>
                        <p class="text-white">Kelola dan lihat pesan pegawai</p>
                    </div>
                </div>
            </div>
        </div>
                ...
                <table class="table table-zebra w-full">
                    <thead>
                        <tr class="bg-base-200">
                            ...
                            <th class="text-left font-semibold text-xs sm:text-sm">Created n</th>
                        </tr>
                    </thead>
                    <tbody>
                        @forelse ($pesan as $p)
