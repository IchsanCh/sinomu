...
@section('meta_description', 'Daftar akun SINOMU untuk mengelola notifikasi otomatis ke pemohon dan pegawai.')
@section('og_description', 'Daftar ke SINOMU dan mulai kirim notifikasi WhatsApp otomatis ke pemohon dan pegawai.')
            ...
            <div class="card bg-base-100 shadow-2xl border border-base-300">
                <div class="card-body p-8 overflow-hidden">
                    <div class="text-center mb-6" data-aos="fade-up" data-aos-duration="700">
                        ...
                        <p class="text-base-content/70">Sign up for your SINOMU account</p>
                    </div>
                    <form method="POST" action="{{ route('signup.store') }}" id="signupForm" class="space-y-6">
                        ...
                        <div class="text-center pt-2">
                            <p class="text-base-content/70 text-sm">
                                ...
                                <a href="{{ route('login') }}" title="Login" class="link link-primary font-medium">
                                    Login</a>
                            </p>
                        </div>
                    </form>
